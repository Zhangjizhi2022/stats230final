...
```{r "plots", echo=FALSE, cache=TRUE}
#trace plot
plot(r2[1,],main='trace plot of beta0 in ISS_MCMC method for n=100')
plot(r2[2,],main='trace plot of beta1 in ISS_MCMC method for n=100')

# for n=100
#beta0
plot(density(r1[1,]),xlab = 'beta1',ylab = 'density',xlim=c(-1.5,-0.5),main='Density plots for beta0 when n=100')
...
#beta1
plot(density(r1[2,]),xlab = 'beta1',ylab = 'density',xlim=c(0.5,1.5),main='Density plots for beta1 when n=100')
...
# for n=500
#beta0
plot(density(r1[1,]),xlab = 'beta1',ylab = 'density',xlim=c(-1.5,-0.5),main='Density plots for beta0 when n=500')
...
#beta1
plot(density(r1[2,]),xlab = 'beta1',ylab = 'density',xlim=c(0.5,1.5),main='Density plots for beta1 when n=500')
...
# for n=1000
#beta0
plot(density(r1[1,]),xlab = 'beta1',ylab = 'density',xlim=c(-1.5,-0.5),main='Density plots for beta0 when n=1000')
...
#beta1
plot(density(r1[2,]),xlab = 'beta1',ylab = 'density',xlim=c(0.5,1.5),main='Density plots for beta1 when n=1000')
