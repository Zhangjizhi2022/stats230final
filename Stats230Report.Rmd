...
However, the use of MCMC for large datasets presents a new research frontier (@Bardenet2014 and @Bardenet2017). This is because when \textbf{X} is large $n \gg 1$, as is typically the case in genomics, spatial statistics and cosmology; evaluating the likelihood ratio appearing in the MRH acceptance ratio is computationally intensive $O(2n^{2})$ (@Bardenet2014).
\[
